...
static struct UART_Device g_uart2_dev = {"uart2",uart_init,uart_send,uart_recv,uart_flush,&huart2};


static struct UART_Device *g_uart_devices[] = {&g_uart2_dev};


struct UART_Device *GetUARTDevice(char *name)
{
	int i = 0;
	for (i = 0; i < sizeof(g_uart_devices)/sizeof(g_uart_devices[1]); i++)
	{
